  ...
  const handleCreate = async () => {
    ...
    try {
      const requestData = {
        ...
        github_branch: formData.sourceType === "github_clone" ? formData.githubBranch || null : null,
        github_zip_url: formData.sourceType === "github_zip" ? (formData.githubZipUrl || null) : null,
      ...
      const result = await invoke<{ success: boolean; message: string; project: any; error?: string }>(
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) => update({ githubZipUrl: e.target.value })}
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              disabled={
                ...
                (formData.sourceType === "github_zip" && !formData.githubZipUrl && tags.length === 0)
              }
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono text-foreground">
                  {formData.sourceType === "github_clone" ? "GitHub Clone" : "GitHub ZIP"}
                </span>
              </div>
              <div className="flex justify-between">
