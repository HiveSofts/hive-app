...
type Framework = "vanilla" | "vanilla-ts" | "vue" | "vue-ts" | "react" | "react-ts" | "preact" | "preact-ts" | "lit" | "lit-ts" | "svelte" | "svelte-ts" | "solid" | "solid-ts" | "qwik" | "qwik-ts";
    ...
    useEffect(() => {
        ...
        const sendCommand = async () => {
            ...
            try {
                ...
                addLine(`> Creating Vite project: ${data.name} with template ${framework.template}`, "info");
