...
interface PhpOverviewPanelProps {
    projectPath: string;
    projectName?: string;
    projectType?: string;
    version?: string;
...
export const PhpOverviewPanel = memo(function PhpOverviewPanel({
    projectPath,
    phpVersion,
    entryPoint,
    host,
                ...
                <div className="p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-6 gap-y-3 text-sm">
                        <div className="flex flex-col gap-0.5">
                            <span className="text-[11px] text-muted-foreground">PHP Version</span>
                        ...
                        <div className="flex flex-col gap-0.5">
                            <span className="text-[11px] text-muted-foreground">Entry Point</span>
