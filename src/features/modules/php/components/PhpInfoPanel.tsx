...
interface PhpInfoPanelProps {
    versions: PhpVersion[];
}

export function PhpInfoPanel({ versions }: PhpInfoPanelProps) {
    ...
    const runTest = () => {
        ...
        setTimeout(() => {
            ...
            setOutput(`PHP ${versionMap[selectedVer] ?? "8.3.14"} (cli) (built: Dec  3 2024 12:30:00) (NTS)
Copyright (c) The PHP Group
Zend Engine v4.3.14, Copyright (c) Zend Technologies
    with Zend OPcache v${versionMap[selectedVer] ?? "8.3.14"}, Copyright (c), by Zend Technologies`);
        }, 1200);
    };
