...
interface NodeVersionCardProps {
    ver: NodeVersion;
...
export function NodeVersionCard({ ver, onInstall, onSetDefault, onRemove }: NodeVersionCardProps) {
            ...
            <div className="flex items-start justify-between">
                <div>
                    <div className="flex items-center gap-2">
                        <Badge
                            variant="outline"
                            className={`font-mono text-sm px-2.5 py-0.5 font-bold ${versionBadgeColor(ver.major)}`}
                        >
                            Node.js {ver.major}
                        </Badge>
                        {ver.lts && (
